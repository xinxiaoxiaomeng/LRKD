...
def parse_option():
    ...
    parser.add_argument('--beta', type=float, default=1.0, help='weight for loss_kl')
    parser.add_argument('--gamma', type=float, default=1.0, help='weight for loss_kd')
    parser.add_argument('--distiller', type=str, default='lrkd')
    # gpu
